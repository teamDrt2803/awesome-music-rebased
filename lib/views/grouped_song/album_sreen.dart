                          ...
                          Obx(
                            () => Positioned(
                              ...
                              child: FloatingActionButton(
                                heroTag: "btn1",
                                onPressed: () async {
                                  final localPath = controller2.getLocalPath +
                                  ...
                                  if (!controller
                                    ...
                                    if (controller2
                                        .isDownloaded(album.songs.first)) {
                                    ...
                                    if (controller.isPlaying) {
                                      ...
                                      await controller.audioHandler.play();
                                    }
                                  }
                                },
                                backgroundColor: controller
                                    ...
                                    controller.albumTopColor,
                                child:
                                    controller.isThisPlaylistPlaying(token) &&
